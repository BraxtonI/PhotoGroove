...
var $author$project$Test$Generated$Main1056730544$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['C:\\Users\\Braxton\\IdeaProjects\\PhotoGroove\\tests\\PhotoGrooveTests.elm']),
		processes: 12,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 183034806426682
	},
	$elm_explorations$test$Test$concat(
		_List_fromArray(
			[
				...
				'PhotoGrooveTests',
				_List_fromArray(
					[$author$project$PhotoGrooveTests$decoderTest, $author$project$PhotoGrooveTests$noPhotosNoThumbnails, $author$project$PhotoGrooveTests$sliders]))
			])));
_Platform_export({'Test':{'Generated':{'Main1056730544':{'init':$author$project$Test$Generated$Main1056730544$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "\\\\.\\pipe\\elm_test-1092-1";
