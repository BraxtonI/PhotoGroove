...
var $author$project$PhotoFolders$LoadPage = function (a) {
	return {$: 'LoadPage', a: a};
};
...
var $author$project$PhotoFolders$init = function (selectedFilename) {
	return _Utils_Tuple2(
		...
		$elm$http$Http$get(
			{
				expect: A2($elm$http$Http$expectJson, $author$project$PhotoFolders$LoadPage, $author$project$PhotoFolders$modelDecoder),
...
var $author$project$Common$Photo = F4(
	function (title, url, size, relatedUrls) {
		return {relatedUrls: relatedUrls, size: size, title: title, url: url};
	});
	...
	A3(
		...
		A3(
			...
			A4(
				...
				$elm$json$Json$Decode$string,
				'(untitled)',
				$elm$json$Json$Decode$succeed($author$project$Common$Photo)))));
...
var $author$project$Common$urlPrefix = 'http://elm-in-action.com/';
...
var $author$project$PhotoGallery$reload = function (newModel) {
	return $author$project$PhotoGallery$applyFilters(newModel);
};
var $author$project$Main$FoldersPage = {$: 'FoldersPage'};
...
var $author$project$Main$toFolders = F2(
	function (model, _v0) {
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{foldersModel: folders, page: $author$project$Main$FoldersPage}),
			A2($elm$core$Platform$Cmd$map, $author$project$Main$GotFoldersMsg, cmd));
	});
var $author$project$Main$GalleryPage = {$: 'GalleryPage'};
...
var $author$project$Main$toGallery = F2(
	function (model, _v0) {
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{galleryModel: gallery, page: $author$project$Main$GalleryPage}),
			...
			switch (_v0.a.$) {
				case 'Gallery':
					...
					return A2(
						...
						model,
						function () {
							var initGalleryModel = $author$project$PhotoGallery$init(model.version);
							return _Utils_eq(model.galleryModel, initGalleryModel.a) ? initGalleryModel : $author$project$PhotoGallery$reload(model.galleryModel);
						}());
				case 'Folders':
					var _v2 = _v0.a;
					return A2(
						...
						model,
						function () {
							var initFoldersModel = $author$project$PhotoFolders$init($elm$core$Maybe$Nothing);
							return _Utils_eq(model.foldersModel, initFoldersModel.a) ? initFoldersModel : _Utils_Tuple2(model.foldersModel, $elm$core$Platform$Cmd$none);
						}());
				default:
					var filename = _v0.a.a;
					var foldersModel = model.foldersModel;
					return A2(
						$author$project$Main$toFolders,
						model,
						_Utils_Tuple2(
							_Utils_update(
								foldersModel,
								{
									selectedPhotoUrl: $elm$core$Maybe$Just(filename)
								}),
...
var $author$project$Main$init = F3(
	function (version, url, key) {
		return A2(
			...
			url,
			{
				foldersModel: $author$project$PhotoFolders$init($elm$core$Maybe$Nothing).a,
				galleryModel: $author$project$PhotoGallery$init(version).a,
				key: key,
				page: $author$project$Main$NotFound,
				version: version
			});
...
var $author$project$Main$subscriptions = function (model) {
	...
	if (_v0.$ === 'GalleryPage') {
		return A2(
			...
			$author$project$PhotoGallery$subscriptions(model.galleryModel));
	} else {
							...
							model,
							{
								status: function () {
									if (photos.b) {
										var first = photos.a;
										var rest = photos.b;
										return A2($author$project$PhotoGallery$Loaded, photos, first.url);
									} else {
			...
			case 'GotFoldersMsg':
				...
				if (_v2.$ === 'FoldersPage') {
					return A2(
						$author$project$Main$toFolders,
						model,
						A2($author$project$PhotoFolders$update, foldersMsg, model.foldersModel));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			default:
				...
				if (_v3.$ === 'GalleryPage') {
					return A2(
						$author$project$Main$toGallery,
						model,
						A2($author$project$PhotoGallery$update, galleryMsg, model.galleryModel));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
		}
...
var $author$project$UI$backgroundColor = A3($mdgriffith$elm_ui$Element$rgb255, 44, 44, 44);
...
var $author$project$UI$fontColor = A3($mdgriffith$elm_ui$Element$rgb255, 250, 250, 250);
var $mdgriffith$elm_ui$Internal$Model$Typeface = function (a) {
	return {$: 'Typeface', a: a};
};
var $mdgriffith$elm_ui$Element$Font$typeface = $mdgriffith$elm_ui$Internal$Model$Typeface;
var $author$project$UI$body = _List_fromArray(
	[
		...
		$mdgriffith$elm_ui$Element$Background$color($author$project$UI$backgroundColor),
		$mdgriffith$elm_ui$Element$Font$color($author$project$UI$fontColor)
	]);
...
var $author$project$UI$selectedPhoto = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$alignLeft,
		$mdgriffith$elm_ui$Element$height(
		A2($mdgriffith$elm_ui$Element$minimum, 400, $mdgriffith$elm_ui$Element$fill)),
...
var $author$project$UI$folderLabel = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$paddingEach(
		_Utils_update(
			$author$project$UI$edges,
...
var $author$project$UI$photo = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$paddingEach(
		_Utils_update(
			$author$project$UI$edges,
...
var $author$project$UI$h2 = _List_fromArray(
	[
...
var $author$project$UI$h3 = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$paddingEach(
		_Utils_update(
			$author$project$UI$edges,
...
var $author$project$UI$image = _List_fromArray(
	[
...
var $author$project$PhotoFolders$viewSelectedPhoto = function (photo) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		$author$project$UI$selectedPhoto,
		_List_fromArray(
			[
				A2(
				$mdgriffith$elm_ui$Element$el,
				...
				$mdgriffith$elm_ui$Element$text('Related')),
				A2(
...
var $author$project$UI$canvas = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$width(
...
var $author$project$UI$contentWrapper = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$paddingEach(
		_Utils_update(
			$author$project$UI$edges,
...
var $author$project$UI$filterLabel = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$width(
...
var $author$project$UI$filterSlider = _List_Nil;
...
var $author$project$UI$slider = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$width(
...
var $author$project$UI$sliderWrapper = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$paddingEach(
		_Utils_update(
			$author$project$UI$edges,
...
var $author$project$UI$thumb = $mdgriffith$elm_ui$Element$Input$thumb(
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$width(
...
var $author$project$PhotoGallery$viewFilter = F3(
	function (toMsg, name, magnitude) {
		return A2(
			$mdgriffith$elm_ui$Element$row,
			$author$project$UI$filterSlider,
			_List_fromArray(
				[
					A2(
					$mdgriffith$elm_ui$Element$el,
					$author$project$UI$filterLabel,
					$mdgriffith$elm_ui$Element$text(name)),
					A2(
					$mdgriffith$elm_ui$Element$el,
					$author$project$UI$sliderWrapper,
					A2(
						$mdgriffith$elm_ui$Element$Input$slider,
						_Utils_ap(
							$author$project$UI$slider,
							_List_fromArray(
								[
						...
						{
							label: $mdgriffith$elm_ui$Element$Input$labelHidden('Filter Slider'),
							max: 11,
							min: 0,
							onChange: toMsg,
							step: $elm$core$Maybe$Nothing,
							thumb: $author$project$UI$thumb,
							value: magnitude
						})),
					A2(
					$mdgriffith$elm_ui$Element$el,
					...
					$mdgriffith$elm_ui$Element$text(
						$elm$core$String$fromInt(
							$elm$core$Basics$round(magnitude))))
				]));
	});
...
var $author$project$UI$borderSize = function (selected) {
	return selected ? 6 : 1;
};
var $author$project$UI$thumbnailBorder = function (selected) {
	var borderColor = selected ? $author$project$UI$blue : $author$project$UI$white;
	return _List_fromArray(
		[
			$mdgriffith$elm_ui$Element$Border$color(borderColor),
			$mdgriffith$elm_ui$Element$Border$width(
			$author$project$UI$borderSize(selected)),
			$mdgriffith$elm_ui$Element$Border$solid
		]);
};
var $author$project$UI$thumbnailPadding = function (selected) {
	return _List_fromArray(
		[
			$mdgriffith$elm_ui$Element$padding(
			7 - $author$project$UI$borderSize(selected))
		]);
};
var $author$project$UI$thumbnailSize = function (size) {
...
var $author$project$PhotoGallery$viewThumbnail = F3(
	function (selectedUrl, size, thumb) {
		var isSelected = _Utils_eq(selectedUrl, thumb.url);
		return A2(
			$mdgriffith$elm_ui$Element$el,
			$author$project$UI$thumbnailPadding(isSelected),
			A2(
				$mdgriffith$elm_ui$Element$el,
				$author$project$UI$thumbnailBorder(isSelected),
				A2(
					$mdgriffith$elm_ui$Element$image,
					_Utils_ap(
						$author$project$UI$thumbnailSize(size),
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$Events$onClick(
			...
			[
				...
				_List_fromArray(
					[
						...
						A2(
						$mdgriffith$elm_ui$Element$row,
						$author$project$UI$contentWrapper,
						_List_fromArray(
							[
								A2(
...
var $author$project$UI$hoverUnderline = _List_fromArray(
	[
		...
		_Utils_update(
			$author$project$UI$edges,
			{bottom: 2})),
		$mdgriffith$elm_ui$Element$Border$color($author$project$UI$backgroundColor),
		$mdgriffith$elm_ui$Element$mouseOver(
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Border$color($author$project$UI$white)
...
var $author$project$UI$nav = function (active) {
	var maybeActive = active ? _List_fromArray(
...
var $author$project$Main$viewHeader = function (page) {
			...
			return A2(
				...
				_List_fromArray(
					[
						A2(
						$mdgriffith$elm_ui$Element$link,
						$author$project$UI$hoverUnderline,
						{
	...
	var logo = A2(
		...
		$mdgriffith$elm_ui$Element$text('Photo Groove'));
	var links = A2(
		$mdgriffith$elm_ui$Element$row,
		_List_Nil,
		_List_fromArray(
		...
		body: _List_fromArray(
			[
				...
				A2(
					...
					_List_fromArray(
						[
							A2($mdgriffith$elm_ui$Element$Lazy$lazy, $author$project$Main$viewHeader, model.page),
							content,
